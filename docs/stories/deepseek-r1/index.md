...
-   [DeepSeek-R1 Technical Report](https://arxiv.org/abs/2501.12948) - January 2025, arXiv The paper describes DeepSeek-R1 as their "first-generation reasoning models" trained via large-scale reinforcement learning, achieving "performance comparable to OpenAI-o1-1217 on reasoning tasks." [ArXiv](https://arxiv.org/abs/2501.12948)
-   [DeepSeek API Documentation](https://api-docs.deepseek.com/news/news250120) - January 20, 2025, DeepSeek The official announcement highlights DeepSeek-R1 as having "⚡ Performance on par with OpenAI-o1" and being a "📖 Fully open-source model & technical report." [Deepseek](https://api-docs.deepseek.com/news/news250120)
-   [DeepSeek-R1 GitHub Repository](https://github.com/deepseek-ai/DeepSeek-R1) - January 2025, GitHub The repository states they "directly apply reinforcement learning (RL) to the base model without relying on supervised fine-tuning (SFT) as a preliminary step," enabling the model to explore chain-of-thought reasoning. [GitHub](https://github.com/deepseek-ai/DeepSeek-R1)
-   [DeepSeek Explained: Everything You Need to Know](https://www.techtarget.com/whatis/feature/DeepSeek-explained-Everything-you-need-to-know) - January 2025, TechTarget According to this article, "DeepSeek released its R1 LLM at a fraction of the cost that other vendors incurred in their own developments" and provided it "under an open source license, enabling free use." [WhatIs](https://www.techtarget.com/whatis/feature/DeepSeek-explained-Everything-you-need-to-know)
-   [DeepSeek-R1 Paper Explained](https://aipapersacademy.com/deepseek-r1/) - January 25, 2025, AI Papers Academy The article notes that DeepSeek-R1 "introduced open-source reasoning models that rivals the performance OpenAI's o1" and uses a simplified reward mechanism that "reduces the cost of the training process." [AI Papers Academy](https://aipapersacademy.com/deepseek-r1/)
-   [DeepSeek Open-Sources DeepSeek-R1 LLM](https://www.infoq.com/news/2025/02/deepseek-r1-release/) - February 4, 2025, InfoQ InfoQ reports that DeepSeek-R1 "outperformed all of them \[Claude-3.5-Sonnet, GPT-4o, and o1\] on several of the benchmarks, including AIME 2024 and MATH-500." [InfoQ](https://www.infoq.com/news/2025/02/deepseek-r1-release/)
-   [DeepSeek LLM GitHub Repository](https://github.com/deepseek-ai/DeepSeek-LLM) - 2023, GitHub This repository for an earlier DeepSeek model notes that "For DeepSeek LLM 7B, we utilize 1 NVIDIA A100-PCIE-40GB GPU for inference" while the 67B model required 8 GPUs, showing their focus on resource requirements. [GitHub](https://github.com/deepseek-ai/DeepSeek-LLM)
-   [Performance Evaluation on LMArena](https://www.infoq.com/news/2025/02/deepseek-r1-release/) - February 2025, InfoQ via LMArena Within days of release, "LMArena announced that DeepSeek-R1 was ranked #3 overall in the arena and #1 in coding and math" and was "tied for #1 with o1 in 'Hard Prompt with Style Control' category." [InfoQ](https://www.infoq.com/news/2025/02/deepseek-r1-release/)
-   [DeepSeek-R1 Distilled Models](https://github.com/deepseek-ai/DeepSeek-R1) - January 2025, GitHub The team created "six dense models (1.5B, 7B, 8B, 14B, 32B, and 70B) distilled from DeepSeek-R1 based on Llama and Qwen" to support the research community with smaller, more accessible models. [GitHub](https://github.com/deepseek-ai/DeepSeek-R1)
-   [DeepSeek-R1 Reinforcement Learning Approach](https://arxiv.org/html/2501.12948v1) - January 2025, arXiv The researchers' approach focused on "improving language model reasoning capabilities using pure reinforcement learning (RL)" to explore "the potential of LLMs to develop reasoning capabilities without any supervised data." [ArXiv](https://arxiv.org/html/2501.12948v1)