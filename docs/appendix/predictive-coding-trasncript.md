# Predictive Coding Transcript

This wonderful video by [Artem Kirsanov](https://kirsanov.ai/) describes
predictive coding, an alternative to the Backpropagation algorithm

[YouTube video on Predictive Coding](https://www.youtube.com/watch?v=l-OLgbdZ3kk)
...
next revolution in machine learning.
...
confusing. So let's unpack what this
means.
...
blackouts every time you learn something
new.
...
alternative, the predictive coding
...
signal that the internal model needs
updating.
...
change? Then we add up all these
effects.
...
how change in x subi affects these
downstream
...
to encode statistical patterns across
many
...
input to output mappings encoded in its
connection
...
settings more efficient than back
propagation.
...
computational advantages for artificial
models.
...
brains and the next generation of neural
network
architectures. 