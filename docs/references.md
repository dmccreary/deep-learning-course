...
1. [JAX ML Book on How to Scale Your Model](https://jax-ml.github.io/scaling-book/) [GitHub Source for Book](https://github.com/jax-ml/scaling-book/) built with jekyll?
